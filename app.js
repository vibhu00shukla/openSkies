...
const { campgroundSchema } = require('./schema.js'); // Assuming you have a schema.js file with the schema defined
const catchAsync = require('./utils/catchAsync'); // Assuming you have a catchAsync utility
const expressError = require('./utils/ExpressError'); // Assuming you have an ExpressError utility
